                    ...
                    <Container sx={container}>
                        <Grid container>
                            <Grid item sm={12} md={12}>
                                ...
                                <Box 
                                    component="img"
                                    src="https://images.cgames.de/images/gamestar/210/gs-wonders-of-the-seas_6197538.jpg"
                                    alt="suitcase"
                                    sx={box.button}
                                    />
                                <Box component="span" sx={imgtext}>
                                    <Box component="span" sx={imgtext.box}>
                                        <Box sx={imgtext.text}>
                                            <Typography variant='body1' sx={imgtext.typography} color="white">Dieses Schiff ist so groß, dass selbst die Titanic darin vier Mal Platz fände</Typography>
                                        </Box>
                                    </Box>
                                </Box>
                                </ButtonBase>
