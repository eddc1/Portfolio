                    ...
                    <Container sx={container}>
                        <Grid container>
                            <Grid item sm={12} md={12}>
                                ...
                                <Box 
                                    component="img"
                                    src="https://images.cgames.de/images/gamestar/210/pile-up_6199346.jpg"
                                    sx={box.button}
                                    />
                                <Box component="span" sx={imgtext}>
                                    <Box component="span" sx={imgtext.box}>
                                        <Box sx={imgtext.text}>
                                            <Typography variant='body1' sx={imgtext.typography} color="white">In dem Aufbauspiel Pile-Up baut ihr fast nur nach oben</Typography>
                                        </Box>
                                    </Box>
                                </Box>
                                </ButtonBase>
...
export default ArtikelPreviews;
