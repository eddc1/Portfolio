                    ...
                    <Container sx={container}>
                        <Grid container>
                            <Grid item sm={12} md={12}>
                                ...
                                <Box 
                                    component="img"
                                    src="https://images.cgames.de/images/gamestar/210/secret-lab-titan-evo-2022-test-teaserbild_6199329.jpg"
                                    alt="suitcase"
                                    sx={box.button}
                                    />
                                <Box component="span" sx={imgtext}>
                                    <Box component="span" sx={imgtext.box}>
                                        <Box sx={imgtext.text}>
                                            <Typography variant='body1' sx={imgtext.typography} color="white">Selten saß ich so gut, aber das hat seinen Preis: Secret Lab Titan Evo 2022 im Test</Typography>
                                        </Box>
                                    </Box>
                                </Box>
                                </ButtonBase>
