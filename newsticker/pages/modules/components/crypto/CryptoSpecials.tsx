...
import AdCryptoSpecials from './AdCrypto/AdCryptoSpecials';
                    ...
                    <Container sx={container}>
                        <Grid container>
                            <Grid item sm={12} md={12}>
                                ...
                                <Box 
                                    component="img"
                                    src="https://images.cgames.de/images/gamestar/210/cod-warzone-2-dmz_6195960.jpg"
                                    alt="suitcase"
                                    sx={box.button}
                                    />
                                <Box component="span" sx={imgtext}>
                                    <Box component="span" sx={imgtext.box}>
                                        <Box sx={imgtext.text}>
                                            <Typography variant='body1' sx={imgtext.typography} color="white">DMZ in CoD Warzone 2: Alles, was wir über den neuen Tarkov-Modus wissen</Typography>
                                        </Box>
                                    </Box>
                                </Box>
                                </ButtonBase>
