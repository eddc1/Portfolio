            ...
            <Grid item xs={11} container spacing={4}>
                ...
                <Grid item xs={12}>
                    <Box sx={{ width: 'auto', height: 'auto', backgroundColor: "#f2f7fc", paddingRight: 2, paddingLeft: 2, paddingBottom: 2 }}>
                            <Typography variant="subtitle2" sx={{ pt: 2, pb: 2 }}>Spiele-Guides auf GameEye: Tipps, Tricks, Lösungen</Typography>
                            <Typography variant="h6" sx={{ fontSize: '0.9rem' }}>Unsere Guide-Übersicht bietet dir alle Tipps, Tricks, Cheats und Ratgeber auf GameStar - inklusive Schritt für Schritt-Anleitungen und Komplettlösungen.
                            </Typography>
                    </Box>
                </Grid>
                {/* <Grid item sx={container} container direction="column">
                ...
                <Grid item sx={container}  >
                    <Grid item sx={container} container direction="row">
                        <Grid item xs={6}>
                                <Typography variant='subtitle1' sx={box.headline}>Top-Crypto</Typography>
                        </Grid>
                        <Grid item xs={6}>
                    ...
                    <Grid item xs={12}>
                            <Box sx={{ width: 'auto', height: 'auto',  paddingTop: 2, paddingBottom: 2 }}>
                                ...
                                <Button size="small">
                                    {/* Funktion die durch Klick die restlichen 5 Top Crypto anzeigen */}
                                    <Grid item>
...
const contentListTopCryptoVideo = [
    {
