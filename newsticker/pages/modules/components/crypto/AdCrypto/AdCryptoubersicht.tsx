            ...
            <Grid item xs={11} container spacing={4}>
                ...
                <Grid item xs={12}>
                    <Box sx={{ width: 'auto', height: 'auto', backgroundColor: "#f2f7fc", paddingRight: 2, paddingLeft: 2, paddingBottom: 2 }}>
                            <Typography variant="subtitle2" sx={{ pt: 2, pb: 2 }}>Alle GameEye-Crypto: Previews, Reports, Meinungen &amp; mehr</Typography>
                            <Typography variant="h6" sx={{ fontSize: '0.9rem' }}>Die Crypto-Übersicht auf GameStar.de mit Previews, Hintergrund-Berichten, Guides, Meinungen, Interviews, Kinofilm-Kritiken und mehr.
                            </Typography>
                    </Box>
                </Grid>
                {/* <Grid item sx={container} container direction="column">
...
export default AdCryptoubersicht;
