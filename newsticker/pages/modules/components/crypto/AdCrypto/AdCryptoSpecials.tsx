            ...
            <Grid item xs={11} container spacing={4}>
                ...
                <Grid item xs={12}>
                    <Box sx={{ width: 'auto', height: 'auto', backgroundColor: "#f2f7fc", paddingRight: 2, paddingLeft: 2, paddingBottom: 2 }}>
                            <Typography variant="subtitle2" sx={{ pt: 2, pb: 2 }}>Specials auf GameEye</Typography>
                            <Typography variant="h6" sx={{ fontSize: '0.9rem' }}>In unserer Special-Übersicht findet ihr Hintergrundinfos, Guides, Film-Rezensionen und mehr.
                            </Typography>
                    </Box>
                </Grid>
                {/* <Grid item sx={container} container direction="column">
...
export default AdCryptoSpecials;
